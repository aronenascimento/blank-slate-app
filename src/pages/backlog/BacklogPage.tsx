...
import { NewTaskRow } from '@/components/NewTaskRow'; // Importando o novo componente
...
export function BacklogView({ tasks, projects, onUpdateTask, onAddTask }: BacklogViewProps) {
  ...
  // Backlog view only shows tasks with BACKLOG status. Tasks are already filtered for !isArchived.
